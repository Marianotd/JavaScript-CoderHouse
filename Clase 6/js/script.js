...
// alumnos.shift()
// const alumnoBrandon = alumnos.pop()
...
// const alumnosEliminados = alumnos.splice(0, alumnos.length)
...
const perro2 = new Perro(2, "Copito de nieve", "Blanco", "Chihuaha", ["Negrito", "Azulcito"])
const perro3 = new Perro(3, "Fatiga", "Marron", "Indefinido", [])
const perro4 = new Perro(4, "Hercules", "Dorado", "Golden", ["Marroncito", "Zafiro", "Pepito"])
